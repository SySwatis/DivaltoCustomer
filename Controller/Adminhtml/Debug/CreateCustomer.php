 ...
 * Class Index
 */
class CreateCustomer extends Action implements HttpGetActionInterface
{
    const MENU_ID = 'Divalto_Customer::CreateCustomer';
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Divalto Create Customer'));
