...
class SiretByVat extends Action
{
     /**
     ...
     * @param \Divalto\Customer\Helper\Vat $vatCustomer
     */
     ...
     public function execute()
     {
          ...
          $vatNumber = $this->_vatCustomer->siretToVatNumber($this->getRequest()->getParam('siret'));
          $checkVatNumber = $this->_vatCustomer->checkVatNumber($vatNumber);
          if( !$checkVatNumber['valid'] ) {  
